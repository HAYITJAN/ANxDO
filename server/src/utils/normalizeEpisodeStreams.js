/**
 * Epizod body uchun `streams` va `videoUrl` ni moslashtiradi (film `normalizeMovieStreams` bilan bir xil mantiq).
 */
function normalizeEpisodeStreams(body) {
...
module.exports = { normalizeEpisodeStreams };
